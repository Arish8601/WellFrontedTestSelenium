...
public class Performance_TC_08_DocumentTest extends BaseClass {
	...
	public void Performance_TC_08_08_DocumentFilter(String SheetName, int rowNum, String Commodity) throws IOException {
		...
		try {
			...
			performance.documentFilter(Commodity,"WPRDocumentTypeButton","WPRFilterOptionType", "PortfolioAndRatingLocAccDocumentTableTr","28","false");
			performance.documentFilter(Commodity,"WPRDocumentReviewStatusButton","WPRFilterOptionStatus", "PortfolioAndRatingLocAccDocumentTableTr","30","false");
			}
		} catch (Throwable t) {
			System.out.println(t.getLocalizedMessage());
			Error e1 = new Error(t.getMessage());
