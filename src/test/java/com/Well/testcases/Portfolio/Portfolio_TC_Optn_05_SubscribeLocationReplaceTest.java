...
public class Portfolio_TC_Optn_05_SubscribeLocationReplaceTest extends BaseClass {
	...
	public void PortfolioSubscribeLocationReplace_TC_05_00_FeatureScorecardUpload(String SheetName,int rowNum, String Commodity) throws IOException {
		...
		pfu.ScorecardUploadSubscribeLocReplace(SheetName, rowNum, Commodity, "Prohibit Indoor Smoking", "Policy and/or Operations Schedule", "A02.1","All Spaces", "Feature", "TestComment", FeaturefileUpload, "A02.1","V2ProjectScorecardPartCount");
	...
	@Parameters({ "SheetName","rowNum", "Commodity" })
	public void PortfolioSubscribeLocationReplace_TC_05_03_UploadFeatureDocumentLibraryReplace(String SheetName,int rowNum, String Commodity) throws IOException {
		TestCaseName = Thread.currentThread().getStackTrace()[1].getMethodName();
		StartTest(TestCaseName,"Upload Alternative Document Functionality");
		try {
			rc.clickDocument();
		    ...
		    pfu.SubscribeLocReplace(SheetName, rowNum, Commodity, "Prohibit Indoor Smoking", "Policy and/or Operations Schedule", "A02.1","All Spaces", "Feature", "TestComment", FeaturefileUpload,"A02.1");
		} catch (Throwable t) {
			System.out.println(t.getLocalizedMessage());
			Error e1 = new Error(t.getMessage());
			e1.setStackTrace(t.getStackTrace());
	...
	@Test(dependsOnMethods = { "com.Well.testcases.Portfolio.Portfolio_TC_Optn_05_SubscribeLocationReplaceTest.PortfolioSubscribeLocationReplace_TC_05_03_UploadFeatureDocumentLibraryReplace" })
	@Parameters({ "SheetName","rowNum", "Commodity" })
