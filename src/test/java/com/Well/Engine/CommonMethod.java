...
//}
	...
	/*
	 * public static Response assertResponseKeyIsNotNullAndExtractResponse (String
	 * key) {
	 * 
	 * return res.then().assertThat().body("any { it.key == '"+key+"' }",
	 * is(notNullValue())).extract().response();
	 * 
	 * }
	 */
}