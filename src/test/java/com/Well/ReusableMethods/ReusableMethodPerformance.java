...
public class ReusableMethodPerformance extends BaseClass {
	...
	public void RegisterPerformance(String SheetName, int rowNum, String DataValidate, String ProjectName)
		...
		CommonMethod.WaitUntilNumberOfElementToBePresentMoreThan("WPROrgContinebtn", 0);
		CommonMethod.RobustclickElementVisible("WPROrgContinebtn", "MandatoryFieldErrorMessage");
...
//		CommonMethod.verifyDropdownValues("WPRConsultant", "Consultant");
		...
		if (DataValidate.equalsIgnoreCase("true")) {
			CommonMethod.WaitUntilNumberOfElementToBePresentMoreThan("HSRLocationBackButton", 0);
			CommonMethod.RobustclickElementVisible("HSRLocationBackButton", "WPROrgContinebtn");
			...
			CommonMethod.VerifyRadioOrCheckboxSelcted("Hsrbilladdcheckbox");
			CommonMethod.WaitUntilNumberOfElementToBePresentMoreThan("WPROrgContinebtn", 0);
			CommonMethod.JavascriptClickElement("WPROrgContinebtn");
			testlog.info("And User clicks on continue button");
			testlog.info("And User verifies the added details about you by clicking on back button");
		}
		Thread.sleep(2000);
		...
		if (CommonMethod.isElementsExist("HsrWPRYesMyOrganizationCbx", 5)) {
			CommonMethod.RobustclickElementVisible("WPRReviewContinuebutton", "MandatoryFieldErrorMessage");
			testlog.info("And User clicks on continue button");
			CommonMethod.WaitUntilNumberOfElementMoreThanToBePresentWithException("MandatoryFieldErrorMessage");
	...
	public void ClickPerformanceProjectId(String SheetName, int rowNum) throws IOException, InterruptedException {
		CommonMethod.WaitUntilNumberOfElementToBePresentMoreThan("WPRIdClick", 0);
		CommonMethod.RobustclickElementVisible("WPRIdClick", "WellV2DashboardTab");
		testlog.info("And User clicks on WprAdminId");
		testlog.info("Then User verifies WprId in search filter");
		CommonMethod.WaitUntilNumberOfElementToBePresentMoreThan("WellV2DashboardTab", 0);
	...
	public void SubmitWPRReview(String SheetName, int rowNum, String ReviewName)
		...
		CommonMethod.WaitUntilNumberOfElementMoreThanToBePresentWithException("ErrorMessage");
	...
	public void SearchPerformanceByStatus(String SheetName, int rowNum) throws IOException, InterruptedException {
		...
		String wprId = data.getCellData(SheetName, "ProjectID", rowNum);
		testlog.info("Performance ID: " + wprId);
		CommonMethod.WaitUntilNumberOfElementToBePresentMoreThan("WPRId", 0);
		...
		int ProjectCount1 = CommonMethod.WaitUntilNumberOfElementToBePresent("V2ProjectSearchResultIDVerify", 1)
		 ...
		 CommonMethod.negativesoftassertFieldValid(CommonMethod.getattributeValueByTextContent("WERIdClick"), data.getCellData(SheetName, "projectID", rowNum),
				"Project name doesn't matches in search");
		String status = CommonMethod.getText("HsrWprStatusResultList");
		testlog.info("Status: " + status);
	...
	public void AdminWprSearch(String SheetName, int rowNum) throws IOException, InterruptedException {
		...
		CommonMethod.WaitUntilClickble("WPRAdminIdSearch", 120)
				.sendKeys(data.getCellData(SheetName, "ProjectID", rowNum));
		testlog.info("And User enter data to WprId");
		CommonMethod.RobustclickElementVisible("WPRAdminApplybtn", "WPRAdminIdClick");
		testlog.info("And User clicks on Apply button");
	...
	public void EditTeamMemberRole(String SheetName, int rowNum) throws IOException, InterruptedException {
		...
		CommonMethod.RobustclickElementVisible("WPRTeamUpdateButton", "TeamMemberDeleteButton");
	...
	public void verifyEditMRCReview(String SheetName, int rowNum)throws IOException, InterruptedException {
		...
		CommonMethod.WaitUntilNumberOfElementToBePresentMoreThan("WPRReviewStatus", 0);
	...
	public void ValidateDashboardHeaderTextAndCards() throws IOException, InterruptedException {
		...
		CommonMethod.WaitUntilNumberOfElementToBeNotPresentWithException("RenewalWprValidateDashboardCommunicateYourAccomplishment");
		CommonMethod.assertisElementPresentFalse("RenewalWprValidateDashboardCommunicateYourAccomplishment", "Communicate your accomplishment:Card is present ");		
		CommonMethod.WaitUntilNumberOfElementToBeNotPresentWithException("RenewalWprValidateDashboardUpdateYourOrganizationalProfile");
		CommonMethod.assertisElementPresentFalse("RenewalWprValidateDashboardUpdateYourOrganizationalProfile", "Update your organizational profile:Card is present ");
	} 
	...
	public void MarkWPRAsAchievedAndValidatePostAchievementDashboard() throws IOException, InterruptedException {
		...
		CommonMethod.WaitUntilNumberOfElementToBePresentMoreThan("V2ProjectValidateDashboardAccomplishmentCard", 0);
		String actualDashboardAccomplishmentCard=CommonMethod.getattributeValueByTextContent("V2ProjectValidateDashboardAccomplishmentCard");
		...
		CommonMethod.WaitUntilNumberOfElementToBePresentMoreThan("V2ProjectValidateDashboardOrganizationalProfile", 0);
		String actualDashboardOrganizationalProfileCard=CommonMethod.getattributeValueByTextContent("V2ProjectValidateDashboardOrganizationalProfile");
...
public void ValidRenewExpireInScorecard(String FeatureName, String DisableType) throws IOException, InterruptedException {
 ...
 public void ValidatePerformanceReActivateBtnAndExpiredFilter() throws IOException, InterruptedException {
  ...
  public void ClickReactivateButton() throws IOException, InterruptedException {
	 ...
	 CommonMethod.RobustclickElementVisible("ReActivateButton", "RenewalTermAndCondition");
  }
 ...
 public void PerformanceDeleteSubset() throws Exception {		
	...
	public void SearchPerformanceByIDAndCompleteTheForm(String SheetName, int rowNum) throws IOException, InterruptedException {
		...
		CommonMethod.negativesoftassertFieldValid(CommonMethod.getText("WPRIdClick"), data.getCellData(SheetName, "ProjectID", rowNum),
				"Project Id doesn't matches in search");
		CommonMethod.Robustclick("WPRIdClick");;
		String Area = CommonMethod.randomNumberBetweenRanges(100, 50000);
		testlog.info("Locationsize: " + Area);
		CommonMethod.clearAndSendKey("WPRlocationsize", Area);
		testlog.info("And User enter the Location Size");
